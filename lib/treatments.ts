...
export const TREATMENTS: TreatmentMeta[] = [
  {
    ...
    title: 'Best Botox & Dermal Fillers in Florida — GlowRoute',
    h1: 'Botox & Dermal Fillers in Florida',
    description: 'Find top-rated Botox and dermal filler clinics across Florida. Compare prices, read real reviews, and book a consultation near you.',
    intro: 'Botox and dermal fillers remain the most popular aesthetic treatments in Florida, with thousands of procedures performed every month across Tampa, Miami, Orlando, and beyond. GlowRoute\'s verified directory helps you find board-certified injectors with proven results. Compare clinics by rating, price, and availability before you book.',
  ...
  },
  {
    ...
    title: 'Best Laser Hair Removal in Florida — GlowRoute',
    h1: 'Laser Hair Removal in Florida',
    description: 'Find the best laser hair removal clinics in Florida. Compare technologies, pricing, and patient reviews at medspas near you.',
    intro: 'Laser hair removal is one of the most sought-after procedures at Florida medspas, offering long-lasting smoothness across all skin types. Modern clinics use advanced diode and Nd:YAG systems for safe, effective results year-round. Use GlowRoute to compare certified providers near you by price, rating, and available technology.',
  ...
  },
  {
    slug: 'hydrafacial',
    name: 'HydraFacial',
    title: 'Best HydraFacial Treatments in Florida — GlowRoute',
    h1: 'HydraFacial in Florida',
    description: 'Discover the best HydraFacial providers in Florida. Find verified clinics offering cleansing, extraction, and hydration treatments near you.',
    intro: 'HydraFacial is a multi-step facial treatment that cleanses, exfoliates, and delivers targeted serums in a single session — with no downtime. It\'s one of the most requested services at Florida medspas for its instant glow and adaptability for all skin types. Find a verified HydraFacial provider in your city with GlowRoute.',
  ...
  },
  {
    ...
    title: 'Best Medical Weight Loss & Ozempic Clinics in Florida — GlowRoute',
    h1: 'Medical Weight Loss & GLP-1 Programs in Florida',
    description: 'Find Florida medspas offering supervised weight loss programs including GLP-1 medications, semaglutide, and metabolic health services.',
  ...
  },
  {
    slug: 'iv-therapy',
    name: 'IV Therapy',
    title: 'Best IV Therapy Clinics in Florida — GlowRoute',
    h1: 'IV Therapy in Florida',
    description: 'Discover IV therapy lounges and wellness clinics in Florida. Find vitamin infusions, NAD+, hydration drips, and immunity boosts near you.',
  ...
  },
  {
    slug: 'microneedling',
    name: 'Microneedling',
    title: 'Best Microneedling Clinics in Florida — GlowRoute',
    h1: 'Microneedling in Florida',
    description: 'Find top microneedling providers in Florida. Compare clinics offering RF microneedling, PRP treatments, and skin rejuvenation.',
    intro: 'Microneedling uses fine needles to stimulate collagen production, improving skin texture, tone, and firmness with minimal downtime. Many Florida clinics now offer RF microneedling (radiofrequency) and PRP combinations for enhanced results. Compare verified microneedling providers across Florida by price, technology, and patient reviews.',
  ...
  },
  {
    slug: 'chemical-peels',
    name: 'Chemical Peels',
    title: 'Best Chemical Peel Clinics in Florida — GlowRoute',
    h1: 'Chemical Peels in Florida',
    description: 'Find the best chemical peel providers in Florida. Compare superficial, medium, and deep peel treatments at verified medspas near you.',
    intro: 'Chemical peels exfoliate the skin using medical-grade acids to improve texture, reduce hyperpigmentation, and stimulate cell renewal. From light glycolic peels to deeper trichloroacetic acid treatments, Florida medspas offer a full spectrum of options for every skin concern. GlowRoute makes it easy to compare providers, prices, and patient reviews before booking.',
  ...
  },
  {
    ...
    title: 'Best TRT & Testosterone Therapy Clinics in Florida — GlowRoute',
    h1: 'TRT & Testosterone Therapy in Florida',
  ...
  },
  {
    ...
    title: 'Best Peptide Therapy Clinics in Florida — GlowRoute',
    h1: 'Peptide Therapy in Florida',
  ...
  },
  {
    ...
    title: 'Best CoolSculpting & Body Contouring in Florida — GlowRoute',
    h1: 'CoolSculpting & Body Contouring in Florida',
    description: 'Find CoolSculpting and non-surgical body contouring clinics in Florida. Compare fat reduction treatments, pricing, and patient reviews.',
