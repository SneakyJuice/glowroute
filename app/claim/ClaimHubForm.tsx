...
export default function ClaimHubForm({
  prefilledClinic = '',
  prefilledSlug = '',
}: {
  prefilledClinic?: string
  ...
  return (
    <div id="start-claim" className="max-w-2xl mx-auto px-4 py-12 scroll-mt-24">
      <div className="mb-8">
        <h2 className="font-serif text-2xl font-semibold text-onyx mb-2">Start your claim</h2>
        <p className="text-stone text-sm leading-relaxed">
          Choose a plan and tell us about your clinic. You can also find your existing listing first
          and claim it from the profile page.
        </p>
      </div>
