...
function CancelContent() {
  return (
    <div className="max-w-lg mx-auto px-4 py-20 text-center">
      ...
      <h1 className="font-serif text-3xl font-semibold text-onyx mb-3">Checkout cancelled</h1>
      <p className="text-stone leading-relaxed mb-8">
        No worries — nothing was charged. You can return and claim your listing whenever you&apos;re ready.
      </p>
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <Link href="/claim" className="inline-block bg-sage text-white text-sm font-semibold px-6 py-3 rounded-xl hover:bg-sage/80 transition-colors">
          Try Again
        </Link>
        <Link href="/clinics" className="inline-block border border-onyx/15 text-onyx text-sm font-semibold px-6 py-3 rounded-xl hover:border-sage/40 hover:text-sage transition-colors">
          Back to Directory
        </Link>
      </div>
    </div>
