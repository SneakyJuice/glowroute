      ...
      <main className="min-h-screen bg-linen">
        ...
        <section className="bg-onyx text-white py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <span className="inline-block bg-sage/10 text-sage text-xs font-medium px-3 py-1 rounded-full">Fertility Preservation</span>
            <span className="inline-block bg-sage/10 text-sage text-xs font-medium px-3 py-1 rounded-full">Cognitive Performance</span>
            </div>
        ...
        <section className="max-w-4xl mx-auto px-4 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>TRT (Testosterone Cypionate)</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Enclomiphene</span></li>
              ...
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>MK-677</span></li>
                </ul>
              </div>

              {/* Strengths */}
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h2 className="text-2xl font-display font-light text-onyx mb-4">Why Maximus?</h2>
                <ul className="space-y-2 text-stone-700">
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Enclomiphene protocols (fertility-preserving TRT)</span></li>
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Peptide stacking</span></li>
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Community + coaching</span></li>
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Performance tracking</span></li>
                </ul>
              </div>
              ...
              <div className="bg-sage/5 border border-sage/20 rounded-xl p-6">
                ...
                <p className="text-stone-700">Men who want high-performance optimization including fertility-preserving TRT and peptides</p>
              </div>
            </div>
