...
export default function FountainTRTPage() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-linen">
        ...
        <section className="bg-onyx text-white py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <span className="inline-block bg-sage/10 text-sage text-xs font-medium px-3 py-1 rounded-full">Testosterone Replacement</span>
            <span className="inline-block bg-sage/10 text-sage text-xs font-medium px-3 py-1 rounded-full">Enclomiphene</span>
            <span className="inline-block bg-sage/10 text-sage text-xs font-medium px-3 py-1 rounded-full">Anastrozole</span>
            </div>
        ...
        <section className="max-w-4xl mx-auto px-4 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Testosterone Cypionate</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Testosterone Enanthate</span></li>
