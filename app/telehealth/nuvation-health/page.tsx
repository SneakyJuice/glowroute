...
export default function NuvationHealthPage() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-linen">
        ...
        <section className="bg-onyx text-white py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <span className="inline-block bg-sage/10 text-sage text-xs font-medium px-3 py-1 rounded-full">Hormone Optimization</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Get Started with Nuvation Health →
              </a>
              <Link
                href="/quiz"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h2 className="text-2xl font-display font-light text-onyx mb-4">About Nuvation Health</h2>
                <p className="text-stone-600 leading-relaxed">Nuvation Health combines advanced diagnostics, hormone optimization, and metabolic health coaching into a precision longevity program delivered entirely online.</p>
              </div>
              ...
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Rapamycin</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Metformin</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>NMN/NAD+</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>GLP-1</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Hormone optimization</span></li>
              <li className="flex items-start gap-2"><span className="text-sage mt-0.5">✓</span><span>Peptides</span></li>
                </ul>
              </div>

              {/* Strengths */}
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h2 className="text-2xl font-display font-light text-onyx mb-4">Why Nuvation Health?</h2>
                <ul className="space-y-2 text-stone-700">
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Longevity focus</span></li>
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Advanced biomarkers</span></li>
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Integrated coaching</span></li>
              <li className="flex items-start gap-2"><span className="text-sage font-bold mt-0.5">→</span><span>Precision protocols</span></li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-5 shadow-sm">
                ...
                <dl className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <dd className="font-medium text-onyx text-right text-xs leading-tight">Health-conscious adults 35+ focused on l</dd>
                  </div>
                </dl>
              </div>
