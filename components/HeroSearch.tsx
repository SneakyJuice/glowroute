    ...
    <section className="relative bg-gradient-to-br from-navy via-navy-mid to-[#1a3a50] py-[52px] px-6 overflow-hidden">
      ...
      <div className="max-w-[820px] mx-auto text-center relative">
        ...
        <div className="bg-white rounded-2xl shadow-lg flex flex-col md:flex-row overflow-hidden">
          <div className="flex-1 flex items-center gap-2.5 px-4 border-b border-gray-200 md:border-b-0 md:border-r">
          ...
          <button className="bg-gradient-to-br from-teal to-teal-light text-white text-[15px] font-semibold px-7 py-4 md:py-0 flex items-center justify-center gap-2 hover:opacity-93 transition-opacity">
