export default function Footer() {
  return (
    <footer className="bg-navy text-white/50 px-6 py-8 mt-0">
      <div className="max-w-7xl mx-auto flex items-center justify-between flex-wrap gap-3">
        <div className="font-serif text-base font-bold text-white">Glow<span className="text-teal-light">Route</span></div>
